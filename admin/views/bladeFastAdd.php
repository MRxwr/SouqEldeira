					  ...
					  <ul class="dropdown-menu">
						<?php
						  if ( $products[$i]["type"] == 0 ){
							echo '<li><a href="?v=AttributesProducts&id='.$products[$i]["id"].'"><i class="fa fa-sitemap"></i></a></li>';
						  }
						  if ( $products[$i]["collection"] == 1 ){
							echo '<li><a href="?v=Collection&id='.$products[$i]["id"].'"><i class="fa fa-object-group"></i></a></li>';
						  }
