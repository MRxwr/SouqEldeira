                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-2">
                            ...
                            <li class="breadcrumb-item"><a
                                    href="/news-list/1"><?php echo direction("News","الأخبار"); ?></a></li>
                            <li class="breadcrumb-item active" aria-current="page">
                                <?php echo direction($news[0]['enTitle'], $news[0]['arTitle']); ?></li>
                        </ol>
                    </nav>
        ...
        <div class="col-md-4 col-sm-12">
            <div class="listings-section">
                ...
                <div class="d-block text-end mt-3">
                    <a href="/news-list/1" class="btn btn-primary"><?php echo direction("More","المزيد"); ?> <i
