...
?>
		...
		<div class="guest-form-action">
		    	...
		    	<div class="start-page-title text-center mb-4">
					<h4><?php echo direction("Edit Ad","تعديل الإعلان"); ?></h4>
			 	</div>
				...
				<div class="form-outline mb-4">
			      ...
			      <!-- Price input -->
			      <div class="form-outline mb-4">
			        <input type="number"  class="form-control" name="adPrice" placeholder="<?php echo direction("Price","السعر"); ?>" value="<?php echo $product[0]["price"]; ?>" required />
			      </div>
			
				  <!-- Title input -->
			      <div class="form-outline mb-4">
			        <input type="text"  class="form-control" name="adTitle" placeholder="<?php echo direction("Title","العنوان"); ?>" value="<?php echo $product[0]["enTitle"]; ?>"  required/>
			      </div>
			      ...
			      <!-- Submit button -->
			      <button type="submit" class="btn btn-primary btn-block w-100 mb-3 py-2"><?php echo direction("Update Ad","تحديث الإعلان"); ?></button>
			      <div class="text-center">  
			      	<p class="add-ad-form-text fw-bold"><?php echo direction("Send us message by","أرسل لنا رسالة عبر"); ?> <a href="https://wa.me/96522281412"><?php echo direction("WhatsApp","واتساب"); ?></a> <?php echo direction("or","أو"); ?> <a href="tel:96522281412"><?php echo direction("call us","اتصل بنا"); ?></a> <?php echo direction("for help","للمساعدة"); ?></p>
			      </div> 
			    </form>
			 </div>
		   </div>
