<h4 class="mb-md-5 mb-3 text-center ad-title"><?php echo Trans('app','A house for rent in Abu Fetera'); ?></h4>
	...
	<div class="row">
        <div class="col-sm-4">
        	<div class="ad-top-details-items">
                ...
                <div class=""> <span class="sp1"><?php echo Trans('app','Price'); ?></span>  <span class="sp2">1500</span></div>
            </div>
        </div>
        <div class="col-sm-1">
        </div>
