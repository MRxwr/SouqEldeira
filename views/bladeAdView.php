	...
	<div class="row">
        ...
        <div class="col-sm-7">  
        	<div class="ad-top-details-items">
                ...
                <div class="share" id="<?php echo direction($ad[0]['enTitle'], $ad[0]['arTitle']) . "{$_SERVER["HTTP_HOST"]}{$_SERVER['REQUEST_URI']}?v=AdView&id={$ad[0]['id']}" ?>"><span class="sp1"><i class="bi bi-share"></i> </span> <span class="sp2"><?php echo Trans('app','Share'); ?></span></div>
            </div> 
        </div>
	</div>
</div>
