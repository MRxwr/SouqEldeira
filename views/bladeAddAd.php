		...
		<div class="guest-form-action">
				...
				<div class="form-outline mb-4">
			      ...
			      <div class="form-outline mb-3">
			         <textarea class="form-control" style="min-height:100px;"  rows="9" name="adDescription" minlength="300" placeholder="<?php echo direction("Description","الوصف"); ?>" required></textarea>
			      </div>
