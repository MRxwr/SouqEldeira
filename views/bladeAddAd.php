		...
		<div class="guest-form-action">
				...
				<div class="form-outline mb-4">
			      ...
			      <div class="text-center">  
			      	<p class="add-ad-form-text fw-bold"><?php echo direction("Send us message by","أرسل لنا رسالة عبر"); ?> <a href="https://wa.me/96566004080"><?php echo direction("WhatsApp","واتساب"); ?></a> <?php echo direction("or","أو"); ?> <a href="?v=Contact"><?php echo direction("call us","اتصل بنا"); ?></a> <?php echo direction("for help","للمساعدة"); ?></p>
			      </div> 
			    </form>
			 </div>
		   </div>
