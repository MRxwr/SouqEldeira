<div class="listings-main-list">
	...
	?>
			<div class="col-lg-12">
				<a style="cursor: pointer" class="card listing-card <?php echo $feature; ?>" <?php /*data-bs-toggle="modal" data-bs-target="#ad_modal" */?> href="<?php echo SeoUrls::titleUrl("ad-view", $ad['id'], $ad['enTitle'], $ad['arTitle']); ?>">
