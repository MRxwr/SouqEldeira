            ...
            <a style="cursor: pointer" class="card listing-card news-card" href="<?php echo $newsUrl; ?>">
                <div class="row g-0 align-items-center">
                    <div class="col-4 col-sm-3 position-relative">
                        <img src="/logos/<?php echo direction($newsItem['enImageurl'], $newsItem['imageurl']); ?>"
                            class="d-block w-100 h-100" style="object-fit: cover; height: 120px;"
                            alt="<?php echo direction($newsItem['enTitle'], $newsItem['arTitle']); ?>">
                    </div>
                    <div class="col-8 col-sm-9">
                        <div class="card-body px-3">
                            <h5 class="card-title fw-bold">
                                <?php echo direction($newsItem['enTitle'], $newsItem['arTitle']); ?></h5>
