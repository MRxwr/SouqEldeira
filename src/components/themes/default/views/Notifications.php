				...
				<div class="col-md-12">
					<section class="section-50">
					    <div class="containerX">
					        ...
					        <div class="notification-ui_dd-content" id="NotificationList">
							<div class="notification-list notification-list--unread">
					            ...
					            <div class="notification-list notification-list--unread">
					                <div class="notification-list_content">
					                    ...
					                    <div class="notification-list_detail">
					                        <p><b><?php echo Trans('app','Badr Mahmoud'); ?></b> <?php echo Trans('app','liked your ad'); ?></p>
					                        <p class="text-muted"><?php echo Trans('app','The number of real estate ads offered for rent or for sale in Kuwait is 4883 new ads'); ?></p>
					                        <p class="text-muted"><small><?php echo Trans('app','10 mins ago'); ?></small></p>
					                    </div>
					                </div>
					        ...
					        <div class="text-center mb-2">   
					            <a id="NotificationsLoad" class="dark-link"><?php echo Trans('app','Load More'); ?></a>
					        </div>
